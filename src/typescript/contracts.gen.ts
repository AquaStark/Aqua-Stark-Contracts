...
export function setupWorld(provider: DojoProvider) {
	...
	const build_AquaStark_newAquarium_calldata = (owner: string, maxCapacity: BigNumberish): DojoCall => {
		return {
			contractName: "AquaStark",
	...
	const AquaStark_newAquarium = async (snAccount: Account | AccountInterface, owner: string, maxCapacity: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const build_AquaStark_newFish_calldata = (owner: string, species: CairoCustomEnum): DojoCall => {
		return {
			contractName: "AquaStark",
			entrypoint: "new_fish",
	...
	const AquaStark_newFish = async (snAccount: Account | AccountInterface, owner: string, species: CairoCustomEnum) => {
		try {
			return await provider.execute(
				snAccount,
